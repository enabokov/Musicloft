...
# 'avicii', 'kongos', 'imagine dragons', 'walk the moon', 'red hot chili peppers', 'System of a down', 'artic monkeys',
artists = ['Sting', 'the offspring', 'Metallica', 'billy talent', 'pink floyd', 'the beatles',
